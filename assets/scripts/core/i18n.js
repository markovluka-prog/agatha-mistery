const I18n = (() => {
    ...
    const translations = {
        ru: {
            ...
            'books.fact2': 'Улисс — не просто кот. На Бали его похитили ради сардин, а в другой книге он серенадами ухаживал за кошкой по имени Мэри. Сибирский кот с голубыми глазами умудряется попадать в приключения чаще, чем любой детектив.',
            ...
            'books.fact4': 'За 30 книг Агата и Бад побывали на 5 континентах. На карте сайта отмечены 46 реальных локаций из 19 книг — от Бермудского треугольника до утёсов Моэр в Ирландии.',
            'books.fact5': 'Билл — орнитолог, который держит ферму у Оксфорда и обучил сокола по имени Марло — в честь Кристофера Марло, английского поэта эпохи Шекспира. У помощников семейства Мистери — всегда самые неожиданные хобби.',
            ...
            'book.1.description': 'В Долине царей группа археологов готовится объявить миру о находке гробницы таинственного фараона — но бесценная табличка с указаниями внезапно похищена. Агата и Бад оказываются в самом сердце Каира: разгадывают улики и расшифровывают иероглифы.',
            'book.2.title': 'Бенгальская жемчужина',
            'book.2.location': 'Индия, Калькутта',
            'book.2.description': 'Из храма Богини Кали в деревне Чотока похищена легендарная жемчужина, а хранитель храма бесследно исчез. Агата и Бад отправляются в Индию — в город специй, шума и многовековых тайн.',
            ...
            'book.5.description': 'Русский дипломат отравлен прямо в ресторане на вершине Эйфелевой башни. Бад случайно выводит из игры единственного агента на месте — и теперь расследование целиком ложится на плечи Агаты. К счастью, она как раз оказалась в Париже.',
            'book.6.title': 'Сокровище Бермудских островов',
            'book.6.location': 'Атлантический океан, Бермудский треугольник',
            'book.6.description': 'Корабли исчезают в Бермудском треугольнике уже сотни лет — и вот Агата и Бад сами оказываются посреди этой загадочной зоны. Карта исчезновений, старинные легенды и кто-то, кто очень не хочет, чтобы тайна раскрылась.',
            ...
            'book.9.description': 'На съёмочной площадке продюсера Роберта Моррисона одно за другим происходят странные происшествия, а актёрам начинают приходить письма с угрозами. Агата и Бад должны выяснить, кто хочет остановить съёмки любой ценой.',
            ...
            'book.15.description': 'Легенда о Дракуле уводит Агату в Румынию — туманные замки, карпатские перевалы и местные, которые слишком хорошо знают, о чём молчать. А Бад тем временем назначает романтическую встречу у Лондонского колеса обозрения.',
            ...
            'book.18.description': 'Десять лет назад из запертого сейфа исчезла секретная формула мастерства. В годовщину смерти мастера один из его учеников получает таинственное письмо — и обращается в агентство. Агата, Бад и мистер Кент отправляются в Лиссабон — город португальской гитары и давних тайн.',
            ...
            'book.20.description': 'Из Пекинского музея искусств похищена статуэтка нефритового дракона. Бад вылетает расследовать дело в одиночку — но вскоре Агата получает тревожное сообщение: Бад сам похищен. Теперь ей нужно найти и статуэтку, и брата.',
            ...
            'book.23.description': 'Из лондонской штаб-квартиры — прямо в Берлин. Зашифрованное послание, пропавший дядя Гельмут и город, который умеет хранить секреты. Дешифровщик Алджернон здесь как нельзя кстати.',
            ...
            'book.26.description': 'Остров Бали — рис, храмы, океан и… пиратское сокровище, которое ищут сразу несколько групп. На Бали Улисс попадает в переделку из-за сардин, а Агата распутывает дело на фоне яванских закатов.',
            ...
            'char.larry': 'Бад Мистери',
            'char.watson': 'Улисс (кот)',
        ...
        en: {
            ...
            'books.intro.p1': 'Agatha Mystery — a twelve-year-old detective from the ancient Mystery family — has a phenomenal memory and a sharp nose for crime. Together with her cousin Bud, a detective school student, and her faithful cat Ulysses, she has traveled around the world — from the Bermuda Islands to Tokyo. In each book — a new country, a new mystery, and a new chance to prove that age is no barrier to a true detective.',
            ...
            'books.fact2': 'Ulysses is not just a cat. In Bali he was kidnapped for sardines, and in another book he courted a cat named Mary with serenades. A Siberian cat with blue eyes manages to get into adventures more often than any detective.',
            ...
            'books.fact4': 'In 30 books, Agatha and Bud visited 5 continents. The site map marks 46 real locations from 19 books — from the Bermuda Triangle to the Moher cliffs in Ireland.',
            'books.fact5': 'Bill is an ornithologist who runs a farm near Oxford and trained a falcon named Marlowe — after Christopher Marlowe, an English poet of Shakespeare\'s era. The Mystery family\'s helpers always have the most unexpected hobbies.',
            ...
            'book.1.description': 'In the Valley of Kings, a group of archaeologists prepare to announce their discovery of a mysterious pharaoh\'s tomb — but a priceless tablet with directions suddenly goes missing. Agatha and Bud find themselves in the heart of Cairo, deciphering clues and decoding hieroglyphics.',
            'book.2.title': 'The Bengali Pearl',
            'book.2.location': 'India, Calcutta',
            'book.2.description': 'A legendary pearl is stolen from the Temple of the Goddess Kali in the Indian village of Chotoka, and the temple keeper vanishes without a trace. Agatha and Bud head to India — a city of spices, noise, and ancient secrets.',
            ...
            'book.5.description': 'A Russian diplomat is poisoned right in a restaurant at the top of the Eiffel Tower. Bud accidentally takes out the only agent on site — now the entire investigation falls on Agatha\'s shoulders. Fortunately, she happens to be in Paris.',
            'book.6.title': 'The Bermuda Islands Treasure',
            'book.6.location': 'Atlantic Ocean, Bermuda Triangle',
            'book.6.description': 'Ships have been disappearing in the Bermuda Triangle for centuries — and now Agatha and Bud find themselves in this mysterious zone. Maps of disappearances, ancient legends, and someone who doesn\'t want the secret revealed.',
            ...
            'book.9.description': 'On producer Robert Morrison\'s film set, strange incidents occur one after another, and actors receive threatening letters. Agatha and Bud must find out who wants to stop production at any cost.',
            ...
            'book.13.description': 'Aboard the luxurious Golden Eagle express crossing all of Russia, Agatha and Bud must prevent a daring robbery of a wealthy passenger. Brilliant thief Strogov — a master of disguise — has openly challenged the agency.',
            ...
            'book.15.description': 'The Dracula legend leads Agatha to Romania — misty castles, Carpathian passes, and locals who know well what to keep silent about. Meanwhile, Bud arranges a romantic meeting at the London Eye.',
            ...
            'book.18.description': 'Ten years ago, a secret formula vanished from a locked safe. On the anniversary of the master\'s death, one of his students receives a mysterious letter — and contacts the agency. Agatha, Bud, and Mr. Kent travel to Lisbon — a city of Portuguese guitars and ancient secrets.',
            ...
            'book.20.description': 'A jade dragon statue is stolen from the Beijing Museum of Arts. Bud flies to Beijing alone to investigate — but soon Agatha receives alarming news: Bud himself has been kidnapped. Now she must find both the statue and her brother.',
            ...
            'book.23.description': 'From their London headquarters — straight to Berlin. An encrypted message, a missing Uncle Helmut, and a city that knows how to keep secrets. Codebreaker Algernon is exactly what\'s needed.',
            ...
            'book.26.description': 'Bali Island — rice fields, temples, ocean… and a pirate treasure sought by several groups. In Bali, Ulysses gets into trouble over sardines, while Agatha unravels the mystery against the backdrop of Javanese sunsets.',
            ...
            'char.larry': 'Bud Mystery',
            'char.watson': 'Ulysses (cat)',
            'char.kent': 'Mr. Kent',
